...
public class Aula02LeituraDeDados {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);//input é a variavel que vai receber algum valor ou qualquer outro conteudo para que depois esse conteudo seja atribuido a uma variavel utilizavel, System.in é um objeto passado por parametro que a principio não deve ser mencionado
        ...
        char sexo = input.next().charAt(0); //Assim a gene pega apenas o primeiro caractere da primeira palavra
