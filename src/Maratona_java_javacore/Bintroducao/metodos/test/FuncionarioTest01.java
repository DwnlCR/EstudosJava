...
public class FuncionarioTest01{
    public static void main(String[] args) {
        ...
        funcionario.setSalarios(new double[] {1550, 890.50, 3040.75, 5000}); //Alterações -> De funcionario.salarios = new double[] {1550, 890.50, 3040.75, 5000}; para funcionario.setSalarios(new double[] {1550, 890.50, 3040.75, 5000});
        funcionario.imprime();
        //Podemos também ver a media atravez do get :)
        System.out.println("Ver media pelo get: "+funcionario.getMedia());
        //Porem temos um problema :( dessa forma tambem conseguimos dizer o valor de media usando funcionario.setMedia(Algum valor), e isso n pode acontecer :(
        //por exemplo:
        //funcionario.setMedia(90000);
        //System.out.println("Ver media pelo get: "+funcionario.getMedia()+" :(");
