...
public class AnimeTest01 {
    public static void main(String[] args) {
        ...
        //Voces n acham muito cansativo ter que sempre ter 3 linhas para setar os valores?
        //q tal a gente criar um metodo que faz isso pela gente? :)
        //Vamos para a classe principal e criaremos nosso metodo init
        anime.init("Acchi Kocchi","Romance Escolar", 24);
        //Essa linha a cima com esse metodo faz o mesmo que as 3 linhas comentadas abaixo
