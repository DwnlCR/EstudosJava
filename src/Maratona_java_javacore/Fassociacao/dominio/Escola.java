...
public class Escola {
    ...
    //levando em consideração que precisamos de muitos professores para 1 escola
    //mas o professor so pode trabalhar em uma escola
    private String nome;
    ...
    public Escola(String nome){ //Para criarmos uma escola estritamente n precisamos de professores ainda ;-;
        //o q a gente precisa mesmo é de um nome, os professor a gente arruma depois
        //por isso o obrigatorio para o construtor de escolas é um nome
        this.nome = nome;
    }
    ...
    //e depois faremos nossa condição, se professor == nulo -> não podemos imprimir professor
    //pq ele tem q existir primeiro né?
    public void imprime(){
        ...
        for(Professor professor : professores){//Aqui o que fizemos foi, criamos um atributo temporario
            //com a mesma estrutura do array professores declarado inicialmente
            //para pegar professor por professor e printar atravez do sout
