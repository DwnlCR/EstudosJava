...
public class Pessoa {
    ...
    //Não é void por que queremos retornar o valor que está dentro do atributo privado
    //é String pois o retorno deve ser o mesmo do atributo que queremos buscar
